...
namespace KWS
{
    internal static class KWS_ShaderConstants
    {
        ...
        public static class ConstantWaterParams
        {
            ...
            public static readonly int KWS_FoamTextureType            = Shader.PropertyToID("KWS_FoamTextureType");
            public static readonly int KWS_FoamTextureContrast        = Shader.PropertyToID("KWS_FoamTextureContrast");
            public static readonly int KWS_FoamTextureScaleMultiplier = Shader.PropertyToID("KWS_FoamTextureScaleMultiplier");
        }
