...
namespace KWS
{
    internal class DrawToPosteffectsDepthPass : WaterPass
    {
        ...
        {
            if (WaterSystem.QualitySettings.DrawToPosteffectsDepth)
            {
                ...
                UnityEngine.Rendering.CoreUtils.SetRenderTarget(waterContext.cmd, waterContext.cameraColor, waterContext.cameraDepth);
