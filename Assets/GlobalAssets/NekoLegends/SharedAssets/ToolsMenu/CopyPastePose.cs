...
namespace NekoLegends
{
    public class CopyPastePose : MonoBehaviour
    {
        ...
        [MenuItem("Tools/Neko Legends/Pose/Copy Keyframe")]
        ...
        [MenuItem("Tools/Neko Legends/Pose/Copy Keyframe", true)]
        static bool ValidateCopyPose()
        {
            return Selection.activeTransform != null;
        }

        [MenuItem("Tools/Neko Legends/Pose/Paste Keyframe")]
        ...
        [MenuItem("Tools/Neko Legends/Pose/Paste Keyframe", true)]
